...
/// This runs only when a read fails the plausibility check, to report what the buffer actually looks like;
/// it is built from synthetic buffers so it's exercised against known layouts without a GPU.</summary>
